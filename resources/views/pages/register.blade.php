...
@section ('metronic-content')
    ...
    <div class="content">
        <!-- BEGIN register FORM -->
        {!! Form::open(['class' => 'register-form', 'route' => 'web.auth.register.post', 'method' => 'POST']) !!}
...
"ZW" => "Zimbabwe"
	...
	'263' => 'Zimbabwe (+263)',
        ...
        <div class="row">
            <hr class="col-xs-7 col-xs-push-2" style="border-top-color: #c6d9f0;">
        </div>
        ...
        <div class="form-actions">
            ...
            <a href="button" class="btn btn-default pull-right">
                Register As Doctor
            </a>
        </div>
    {!! Form::close() !!}
        ...
        var Register = {
            ...
            handelRegister: function () {
                ...
                function format(state) {
                    ...
                    var $state = $(
                        '<span><img src="../assets/global/img/flags/' + state.element.value.toLowerCase() + '.png" class="img-flag" style="margin-right: 5px;" /> ' + state.text + '</span>'
                    );
