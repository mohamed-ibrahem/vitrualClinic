...
@section ('metronic-content')
    ...
    <div class="content">
        <!-- BEGIN register FORM -->
        {!! Form::open(['class' => 'register-form', 'id' => 'register-form', 'route' => ['web.auth.register.post', 'doctor'], 'method' => 'POST']) !!}
        ...
        <div class="form-wizard">
                    ...
                    <ul class="row step-background-thin">
                        ...
                        <li class="bg-grey-steel col-md-4 mt-step-col">
                            <a href="#tab3" data-toggle="tab" class="step" aria-expanded="true">
                                ...
                                <div class="mt-step-title uppercase font-grey-cascade">More!</div>
                                <div class="mt-step-content font-grey-cascade">Talk more</div>
                            </a>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                @component('layout.partials.components.bs3-input', [
                                    ...
                                    'type' => 'select',
                                    'title' => 'specialities',
                                    'list' => \App\Speciality::pluck('display_name', 'id'),
                                    'icon' => 'fa fa-at',
                                    'inputClass' => 'select2',
                                    'labelClass' => 'visible-ie8 visible-ie9',
                                    'extra' => [
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('web.auth.register', ['role' => 'member']) }}"
                   class="btn btn-default pull-right button-create-doctor">
                    Register As Member
                </a>
            </div>
        </div>
...
@push ('styles')
    ...
    <style>
        ...
        .register .content .form-group:not(.has-error) .form-control, .select2-container--bootstrap .select2-selection {
            border: 1px solid #c2cad8;
        }

        .register .content .form-control, .select2-container--bootstrap .select2-selection {
            color: #8290a3;
            background-color: #dde3ec;
        }

        .register .content .form-control:not(textarea), .select2-container--bootstrap .select2-selection {
            height: 43px;
        }

        .input-group-addon .select2-container--bootstrap .select2-selection {
            height: 41px;
            border: none;
        }
