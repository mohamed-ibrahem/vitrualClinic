                    ...
                    <tr class="odd gradeX">
                        ...
                        <td class="text-right">
                            <div class="btn-group btn-group-xs">
                                <a href="{{ route('admin.admins.show', $user) }}" class="btn btn-primary tooltips" data-original-title="{{ trans('general.datatable.tools.show') }}" data-container="body" data-placement="top">
                                    <i class="fa fa-fw fa-eye"></i>
                                </a>
                                <a href="{{ route('admin.admins.edit', $user) }}" class="btn btn-warning tooltips" data-original-title="{{ trans('general.datatable.tools.edit', ['user' => $user->name]) }}" data-container="body" data-placement="top">
                                    <i class="fa fa-fw fa-edit"></i>
                                </a>
                            </div>

                            <div class="btn-group btn-group-xs">
                                <a href="{{ route('admin.admins.destroy', $user) }}" class="btn btn-danger tooltips" data-original-title="{{ trans('general.datatable.tools.delete') }}" data-container="body" data-placement="top">
